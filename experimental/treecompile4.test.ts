...
describe(`Merkle Tree contract`, () => {
  it(`should compile contracts`, async () => {
    ...
    const json = {
      name: TreeCalculation.name,
      publicInputs: TreeCalculation.publicInputType,
      publicOutputs: TreeCalculation.publicOutputType,
      privateInputs: TreeCalculation.privateInputTypes,
      methods: TreeCalculation.rawMethods,
    };
    console.log(json);
  });
});
