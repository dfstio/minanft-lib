...
describe("Payment", () => {
  ...
  it(`should mint NFT`, async () => {
    ...
    const tx = await Mina.transaction(
      { sender: owner.publicKey, fee, memo: "mint" },
      async () => {
  ...
  it(`should update NFT using TrustedUpdate`, async () => {
    ...
    const tx = await Mina.transaction(
      { sender: owner.publicKey, fee, memo: "trusted update" },
      async () => {
  ...
  it(`should update NFT`, async () => {
    ...
    await fetchAccount({ publicKey: nftPublicKey, tokenId });
    const tx = await Mina.transaction(
      { sender: owner.publicKey, fee, memo: "update" },
      async () => {
        await zkApp.update({
          address: nftPublicKey,
          metadataParams,
  ...
  it(`should sell NFT`, async () => {
    ...
    await fetchAccount({ publicKey: nftPublicKey, tokenId });
    const tx = await Mina.transaction(
      { sender: owner.publicKey, fee, memo: "sell" },
      async () => {
        await zkApp.sell({
          address: nftPublicKey,
          price,
  ...
  it(`should buy NFT`, async () => {
    ...
    await fetchAccount({ publicKey: nftPublicKey, tokenId });
    const tx = await Mina.transaction(
      { sender: owner2.publicKey, fee, memo: "buy" },
      async () => {
        await zkApp.buy({
          address: nftPublicKey,
          price,
  ...
  it(`should transfer NFT`, async () => {
    ...
    await fetchAccount({ publicKey: nftPublicKey, tokenId });
    const tx = await Mina.transaction(
      { sender: owner.publicKey, fee, memo: "transfer" },
      async () => {
  ...
  it(`should sell NFT with KYC`, async () => {
    ...
    await fetchAccount({ publicKey: nftPublicKey, tokenId });
    const tx = await Mina.transaction(
      { sender: owner.publicKey, fee, memo: "sell with KYC" },
      async () => {
  ...
  it(`should buy NFT with KYC`, async () => {
    ...
    await fetchAccount({ publicKey: nftPublicKey, tokenId });
    const tx = await Mina.transaction(
      { sender: owner4.publicKey, fee, memo: "buy with KYC" },
      async () => {
